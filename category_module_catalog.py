...
MODULE_GROUPS: List[Dict[str, Any]] = [
    ...
    },
    {
        ...
        "modules": [
            ...
            _mod("coaches", "Coaches", permission_keys=["manage_users"], rbac=[Permission.MANAGE_COACHES.value],
...
DEFAULT_ENABLED_MODULES: Dict[str, Set[str]] = {
    ...
    UserRole.ALPHA_ADMIN.value: {
        ...
        "alpha-expenses",
        "attendance-take", "attendance-reports", "coach-attendance-admin", "ground-booking",
